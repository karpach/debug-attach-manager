...
namespace comScoreInc.DebugAttachHistory
{
    ...
    [Guid(GuidList.guidDebugAttachHistoryPkgString)]
    public sealed class DebugAttachHistoryPackage : Package
    {
        ...
        /// </summary>
        public DebugAttachHistoryPackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID toolwndCommandID = new CommandID(GuidList.guidDebugAttachHistoryCmdSet, (int)PkgCmdIDList.cmdidSmartDebugAttacher);
                MenuCommand menuToolWin = new MenuCommand(ShowToolWindow, toolwndCommandID);
                mcs.AddCommand( menuToolWin );
                toolwndCommandID = new CommandID(GuidList.guidDebugAttachHistoryCmdSet, (int)PkgCmdIDList.cmdidAttachSmartDebug);
